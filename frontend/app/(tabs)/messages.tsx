...
export default function MessagesScreen() {
            ...
            if (list.length === 0) {
                setThreads([
                    ...
                    },
                    {
                        ...
                        lastMessage: 'Hello, we received your inquiry regarding your domestic worker placement.',
                        time: 'Yesterday',
                        unreadCount: 0,
                        verified: true,
                    },
    ...
    const filteredThreads = threads.filter((t) => {
        ...
        return agencyName.toLowerCase().includes(q) || msg.toLowerCase().includes(q);
    });
                ...
                <View className="flex-row items-center justify-between">
                    <View>
                        ...
                        <Text className="text-slate-500 text-xs mt-0.5 font-medium">
                            Direct communication line with licensed MOLSA agencies
                        </Text>
                    </View>
                    <Pressable
            ...
            <View className="px-5 my-4">
                <View className="flex-row items-center bg-white border border-slate-200 rounded-2xl px-4 py-1 shadow-xs">
                    ...
                    <TextInput
                        ...
                        placeholder="Search agency thread or message..."
                    ...
                    {filteredThreads.length === 0 ? (
                        <View className="bg-white p-8 rounded-2xl border border-slate-200 items-center justify-center mt-4 shadow-xs">
                            ...
                            <Text className="text-slate-500 text-xs text-center mt-1">
                                Visit the Agencies tab to contact verified recruitment agencies.
                            </Text>
                        </View>
                    ) : (
